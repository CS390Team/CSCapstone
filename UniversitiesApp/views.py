...
def getCourse(request):
    if request.user.is_authenticated():
        ...
        # if in_university_name == "":
        #     if request.user.university_set.empty():
        #         return render(request, 'universityform.html', {'error' : 'Error: That university name already exists!'})
        #     for uni in in_universities:
        #         print uni.name
            # in_professor = request.user.professor
            # print in_professor
            # in_university = in_professor.university
            # print in_university
            # in_university_name = request.user.professor.university.name
