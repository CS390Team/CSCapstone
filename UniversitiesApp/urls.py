...
urlpatterns = [
    ...
    url(r'^university/course/addstudentsform$', views.addStudentsForm, name="AddStudentsForm"),
    url(r'^university/course/addstudents$', views.addStudents, name="AddStudents"),
    url(r'^university/course/removestudent$', views.removeStudent, name="RemoveStudents"),
	...
	url(r'^university/courses$', views.getCourses, name="Courses"),
